...
export default function GetQuoteSection({setConfirmation, reference}) {
    return (
        <>
            <div ref={reference}
                ...
                <div className="fixed w-full h-screen top-0 left-0 overflow-hidden filter blur-sm opacity-30"
                     style={{zIndex: -1}}>
                    <img src={"/img/bg.png"} className="w-full h-full object-cover object-center" alt={'background'}/>
                </div>
                        ...
                        <div className="w-full h-full">
                            ...
                            <div className="p-8 pb-10">
                                <div className="slide-down mb-8">
                                    <h1 className="text-primary text-center text-2xl sm:text-3xl md:text-5xl font-bold">Lets
                                        do
                                ...
                                <form onSubmit={(e) => e.preventDefault()}
                                    ...
                                    <div>
                                        <label htmlFor="tel" className="text-primary">Phone Number</label>
                                        <input id="tel" name="Phone" type="tel" className="form-input"/>
                                    </div>
                                    <div>
                                        <label htmlFor="comp-name" className="text-primary">Company Name</label>
                                        <input id="comp-name" name="Company Name" className="form-input"/>
                                    </div>
                                    <div>
                                        <label htmlFor="comp-website" className="text-primary">Company website</label>
                                        <input id="comp-website" name="Company Website" className="form-input"/>
                                    </div>
                                    <div>
                                        <label htmlFor="services" className="text-primary">Service</label>
                                        <select id="services" name="Service" className="form-input">
                                            {services.map((service) => <option>{service.title}</option>)}
                                        </select>
                                    </div>
                                    <div className="sm:col-span-2">
                                        <label htmlFor="comments" className="text-primary">Comments</label>
                                        <textarea id="comments" name="Comments" className="form-input"/>
                                    </div>
                                    <button type="submit" onClick={() => setConfirmation(true)}
                                            className="button-accent px-16 mt-4 self-end sm:col-span-2">Submit
                                    </button>
                                </form>
                            </div>
                        </div>
