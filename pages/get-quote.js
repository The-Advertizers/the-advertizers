export default function GetQuotePage() {
    return (
        <>
            {/* <!-- Form Confirmation --> */}
            <div id="confirmation" className="hidden fixed z-50 top-0 left-0 w-screen h-screen">
                <div className="w-full h-full">
                    <div className="w-full h-full flex flex-col items-center justify-center">
                        <div id="confirmation-dialog" className="py-4 px-8 bg-white z-50 rounded-md">
                            <h1 className="text-2xl font-bold">Submitted</h1>
                            <p>Your request has been submitted, <br /> our team will reach you soon with the appropriate
                                information.</p>
                        </div>
                    </div>
                    <div className="fixed top-0 left-0 w-screen h-screen z-40 bg-black bg-opacity-40"></div>
                </div>
            </div>
            ...
            <div id="home" className="block device-width min-h-screen bg-secondary">
                ...
                {/* <!-- SCROLL DOWN --> */}
                <div className="w-full mb-10 absolute z-40 bottom-0 grid justify-items-center text-white lg:grid">
                    <svg className="animate-pulse h-16 w-16 p-4 fill-current cursor-pointer" onclick="scrollToQuotation()"
                        viewBox="0 0 970.586 970.586" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <!-- CONTACT US --> */}
            <div id="contact-us" className="relative flex flex-col bg-fixed device-width min-h-screen bg-secondary h-full object-cover bg-no-repeat bg-bottom" style={{ backgroundImage: "url(\"/img/World_map.png\")" }}>
                ...
                <div
                    ...
                    <div className="bg-transparent relative border-b border-t sm:border grid grid-cols-1 gap-4 md:grid-cols-2 sm:rounded-lg py-4 md:px-4 backdrop-filter backdrop-blur-sm"
                    >
                        ...
                        <div
                            ...
                            <div className="pb-12">
                                <div className="p-1 flex">
                                    <svg className="text-primary inline-block w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg"
                                ...
                                0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                    ...
                                    <p className="text-primary inline-block menu"><a href="tel:+923011119520">+92 3011119520</a></p>
                                </div>
                                ...
                                <div className="p-1 flex">
                                    ...
                                    <p className="text-primary inline-block menu"><a
                                        href="https://goo.gl/maps/iHBWukjp8qF6WNxe9">Office# 340, 6th Floor,<br /> Ashiana
                     ...
                     border-t border-white pt-4">
                                <a className="w-6 h-6 mx-2 text-primary hover:text-accent"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-current" role="img" viewBox="0 0 24 24">
                 ...
                 p-8 sm:-mx-8 md:mx-0 md:mr-8 sm:my-0 md:-my-8 pr-10 sm:rounded-lg slide-right">
                            <div className="flex flex-col self-center justify-center">
                                <label>
                                    ...
                                    <input id="cu-subj" className="form-input" type="text" placeholder="Website Contact Form" />
                                </label>
                                <label>
                                    <span>
                                        <p className="text-secondary uppercase font-light">Body</p>
                                    </span>
                                    <textarea id="cu-body" className="form-input resize-none h-32" type="text"
                ...
                {/* <!-- FOOTER --> */}
                <div className="absolute bottom-0 flex w-full px-4 py-3 flex-wrap overflow-hidden">
                    <h6 className="text-primary text-right w-full slide-up menu font-light">
                        <a className="text-accent font-lemon font-normal" href="#home">The Advertizers</a> © <span
                            id="tx-year"></span> All Rights
                        Reserved
                    </h6>
                </div>
            </div>
